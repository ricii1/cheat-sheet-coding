# vLLM Cheat Sheet
- [vLLM Cheat Sheet](#vllm-cheat-sheet)
  - [Instalasi vLLM](#instalasi-vllm)
    - [Instalasi dengan pip](#instalasi-dengan-pip)
    - [Instalasi dengan Constraints (Recommended)](#instalasi-dengan-constraints-recommended)
    - [Instalasi dari Source](#instalasi-dari-source)
    - [Instalasi dengan Docker](#instalasi-dengan-docker)
    - [Cek Versi vLLM](#cek-versi-vllm)
    - [Update vLLM](#update-vllm)
  - [Menjalankan vLLM Server](#menjalankan-vllm-server)
    - [OpenAI-Compatible API Server](#openai-compatible-api-server)
    - [Server dengan Model Lokal](#server-dengan-model-lokal)
    - [Server dengan Quantization](#server-dengan-quantization)
    - [Server dengan Multi-GPU](#server-dengan-multi-gpu)
    - [Server dengan Custom Config](#server-dengan-custom-config)
    - [Background Service (systemd)](#background-service-systemd)
  - [Menggunakan vLLM API](#menggunakan-vllm-api)
    - [Chat Completions API](#chat-completions-api)
    - [Chat dengan Conversation History](#chat-dengan-conversation-history)
    - [Chat dengan Parameters](#chat-dengan-parameters)
    - [Streaming Response](#streaming-response)
    - [Completions API (Legacy)](#completions-api-legacy)
    - [List Models API](#list-models-api)
    - [Embeddings API](#embeddings-api)
  - [Python Client](#python-client)
    - [Menggunakan OpenAI SDK](#menggunakan-openai-sdk)
    - [Streaming dengan Python](#streaming-dengan-python)
  ...
  - [Troubleshooting](#troubleshooting)
    ...
    - [CUDA Compatibility Issues](#cuda-compatibility-issues)
  ...
  - [Tips dan Best Practices](#tips-dan-best-practices)
    ...
    - [Monitoring dengan Prometheus](#monitoring-dengan-prometheus)
    - [Integration dengan Popular Frameworks](#integration-dengan-popular-frameworks)
